import { Box, IconButton, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TableRow } from "@mui/material";
...
const AcademicAdministrationProposal = () => {
    return (
        <Box>
...
export default AcademicAdministrationProposal;